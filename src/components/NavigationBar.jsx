...
const NavigationBar = () => {
  ...
  // Function to handle icon clicks and scroll to section
  const handleSectionClick = (section) => {
    setActiveSection(section);

    // Scroll to section or navigate to route (if using React Router)
    document.getElementById(section)?.scrollIntoView({ behavior: "smooth" });
  };
  
  return (
    <div className="flex flex-col fixed items-start z-50 gap-[1.25vw] px-[0.63vw] py-[0.42vw]  left-[3.33vw] top-[5.5vw] rounded-[40px] border border-white bg-[#1A1E23]">
      <div className={`p-[0.42vw] rounded-[2.08vw] ${
          activeSection === "home" ? "bg-white" : "hover:bg-white"
      ...
      >
        <svg
          ...
          viewBox="0 0 24 24"
          className={`${
            activeSection === "home" ? "fill-[#292F36]" : "fill-white"
          } hover:fill-[#292F36]`}
        >
          <path
            fill-rule="evenodd"
      ...
      <div className={`p-[0.42vw] rounded-[2.08vw] ${
          activeSection === "about" ? "bg-white" : "hover:bg-white"
        } transition duration-150 ease-in-out`}
        ...
        <svg
          ...
          height="1.25vw"
          viewBox="0 0 24 24"
          className={`transition-colors duration-100 ${activeSection === "about" ? "fill-[#292F36]" : "fill-white"
          } hover:fill-[#292F36]`}
        >
          <path
            fill-rule="evenodd"
      ...
      <div className={`p-[0.42vw] rounded-[2.08vw] ${
          activeSection === "skills" ? "bg-white" : "hover:bg-white"
        } transition duration-150 ease-in-out`}
        ...
        <svg
          ...
          height="1.25vw"
          viewBox="0 0 24 24"
          className={`transition-colors duration-100 ${activeSection === "skills" ? "fill-[#292F36]" : "fill-white"
          } hover:fill-[#292F36]`}
        >
          <path d="M8.70711 6.70711C9.09763 6.31658 9.09763 5.68342 8.70711 5.29289C8.31658 4.90237 7.68342 4.90237 7.29289 5.29289L1.29289 11.2929C0.902369 11.6834 0.902369 12.3166 1.29289 12.7071L7.29289 18.7071C7.68342 19.0976 8.31658 19.0976 8.70711 18.7071C9.09763 18.3166 9.09763 17.6834 8.70711 17.2929L3.41421 12L8.70711 6.70711Z" />
          <path d="M16.7071 5.29289C16.3166 4.90237 15.6834 4.90237 15.2929 5.29289C14.9024 5.68342 14.9024 6.31658 15.2929 6.70711L20.5858 12L15.2929 17.2929C14.9024 17.6834 14.9024 18.3166 15.2929 18.7071C15.6834 19.0976 16.3166 19.0976 16.7071 18.7071L22.7071 12.7071C23.0976 12.3166 23.0976 11.6834 22.7071 11.2929L16.7071 5.29289Z" />
      ...
      <div className={`p-[0.42vw] rounded-[2.08vw] ${
          activeSection === "works" ? "bg-white" : "hover:bg-white"
        } transition duration-150 ease-in-out`}
        ...
        <svg
          ...
          height="1.25vw"
          viewBox="0 0 24 24"
          className={`transition-colors duration-100 ${activeSection === "works" ? "fill-[#292F36]" : "fill-white"
          } hover:fill-[#292F36]`}
        >
          <path
            fill-rule="evenodd"
      ...
      <div className={`p-[0.42vw] rounded-[2.08vw] ${
          activeSection === "blogs" ? "bg-white" : "hover:bg-white"
        } transition duration-150 ease-in-out`}
        ...
        <svg
          ...
          height="1.25vw"
          viewBox="0 0 24 24"
          className={`transition-colors duration-100 ${activeSection === "blogs" ? "fill-[#292F36]" : "fill-white"
          } hover:fill-[#292F36]`}
        >
          <path
            fill-rule="evenodd"
      ...
      <div className={`p-[0.42vw] rounded-[2.08vw] ${
          activeSection === "contact" ? "bg-white" : "hover:bg-white"
        } transition duration-150 ease-in-out`}
        ...
        <svg
          ...
          height="1.25vw"
          viewBox="0 0 24 24"
          className={`transition-colors duration-100 ${activeSection === "contact" ? "fill-[#292F36]" : "fill-white"
          } hover:fill-[#292F36]`}
        >
          <path
            fill-rule="evenodd"
